...
*** Capture
    ...
    #+begin_src emacs-lisp
      ...
      (defun na-org-capture-email-gmail (title)
        (replace-regexp-in-string " - nurullah@nakkaya.com - nakkaya.com Mail" "" title))
      ...
      (setq org-capture-templates
            '(("l" "Link" entry (file+olp "~/annex/notes/bookmarks.org" "Read Later")
              ...
              ("e" "Email" entry (file+olp "~/annex/notes/brain.org" "Tasks")
               "* EMAIL %(na-org-capture-email-gmail (na-page-title (current-kill 0)))\n  %?%i\n  %l\n" :prepend t)
              ))
    #+end_src
