...
** Load/Install Melpa Packages
   ...
   #+begin_src emacs-lisp
     ...
     (setq package-list '(magit clojure-mode expand-region dash python-mode evil))
   ...
   #+begin_src emacs-lisp
     ...
     (defun evil-space-del (statemap)
       ...
       (define-key statemap (kbd "DEL") (lambda ()
                                          (interactive)
                                          (evil-scroll-up nil)))
       (define-key statemap (kbd "]") (lambda ()
                                        (interactive)
                                        (ibuffer))))
     ...
     (evil-define-key 'normal evil-org-mode-map
       "a" 'jump-to-org-agenda
       "c" 'org-archive-subtree
       "s" 'na-search-org-headers
...
** Cpp
   ...
   #+begin_src emacs-lisp 
     ...
     (define-skeleton skel-cpp-sprint
       ""
       nil
       \n >
       "Serial.print(" _ ");"
       \n >)
     (define-abbrev c++-mode-abbrev-table "sprt"  "" 'skel-cpp-sprint)
