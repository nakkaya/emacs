...
** Load/Install Melpa Packages
   ...
   #+begin_src emacs-lisp
     ...
     (setq package-list '(magit clojure-mode expand-region dash python-mode git-annex hy-mode
                                monroe clojure-mode-extra-font-locking autopair
                                multi-term dired-details pixie-mode yaml-mode))
...
** Theme
  ...
  #+begin_src emacs-lisp 
    (defvar theme-background "#060606")
        ...
        (progn 
          ...
          (eval-after-load "diff-mode" 
            '(progn
               ...
               (set-face-background 'diff-header theme-background)
               (set-face-background 'diff-file-header theme-background)
               (set-face-background 'diff-file-header "#121212")
               (set-face-background 'diff-refine-change "#121212"))))
      (progn 
        (set-face-foreground 'default "color-250")
        (set-face-background 'default theme-background)
        (set-face-background 'match "black")
        ...
        (eval-after-load "magit" 
          '(progn
             ...
             (set-face-background 'magit-diff-hunk-heading "black")
...
** ERC
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq erc-autojoin-channels-alist
               '(("freenode.net" "#clojure" "#hy" "#pixie-lang")
