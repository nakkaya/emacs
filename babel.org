...
** Load/Install Melpa Packages
   ...
   #+begin_src emacs-lisp
     ...
     (setq package-list '(magit clojure-mode nrepl god-mode expand-region))
...
** Org
   ...
   #+BEGIN_SRC sh :tangle ~/.bin/org-mobile-sync.sh
     #!/bin/bash
     
     # @hourly sh /home/nakkaya/.bin/org-mobile-sync.sh >/dev/null 2>&1
     
     emacsclient --eval "(org-mobile-pull)" --eval "(org-mobile-push)"
   #+END_SRC
