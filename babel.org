    ...
    #+begin_src emacs-lisp
      (defvar git-annex-async-dired-map
        (let ((map (make-keymap)))
          ...
          (define-key map "?" 'na-annex-status)
   ...
   #+begin_src emacs-lisp
     (defun na-export-html ()
       ...
       (let* ((file (concat (car (split-string (buffer-name) "\\.")) ".html"))
              (out-file (concat "~/annex/public/" file)))
...
*** agenda
    ...
    #+begin_src emacs-lisp
      (setq org-mobile-inbox-for-pull "~/annex/org/from-mobile.org")
      (setq org-mobile-directory "/scpc:nakkaya@5.9.103.70#443:/home/nakkaya/mobile-org")
      (setq org-mobile-files (list "~/annex/org/gtd.org"))
      (setq org-agenda-files (list "~/annex/org/gtd.org"))
