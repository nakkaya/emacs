...
** Load/Install Melpa Packages
   ...
   #+begin_src emacs-lisp
     ...
     (setq package-list '(magit clojure-mode expand-region python-mode ein git-annex
                          ...
                          multi-term yaml-mode matlab-mode doom-themes))
...
(defvar theme-background (face-attribute 'default :background))


(set-face-background 'org-block-background theme-background)
(set-face-background 'org-block theme-background)

(set-face-foreground 'font-lock-comment-face
                     theme-background)
(set-face-background 'font-lock-comment-face
...
(eval-after-load "magit" 
  '(progn
     ...
     (set-face-foreground 'magit-diff-hunk-heading
...
(eval-after-load "ein-cell"
  '(progn
     ...
     (set-face-attribute  'ein:cell-output-stderr nil :background theme-background)))
#+END_SRC
