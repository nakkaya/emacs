...
*** Git Annex
    ...
    #+begin_src emacs-lisp
      (defun na-annex-rename ()
        ...
        (let* ((file (file-name-nondirectory (dired-get-filename)))
               (to-name (read-directory-name "Rename To: "))
               annex-command)
    ...
    #+begin_src emacs-lisp
      (defun na-annex-delete ()
        ...
        (let* ((file (file-name-nondirectory (dired-get-filename)))
               annex-command)
          (setq annex-command (concat "git rm " file "; git commit -m Deleted"))
          (shell-command annex-command)))
    #+end_src
...
** mu4e
   ...
   #+begin_src emacs-lisp
     ...
     (setq mu4e-html2text-command "/home/nakkaya/Dropbox/bash/wash-html.sh")
