...
** Load Path
   ...
   #+begin_src emacs-lisp 
     ...
     (add-to-list 'load-path (concat dotfiles-dir "/ext/nrepl.el.git/"))
     (add-to-list 'load-path (concat dotfiles-dir "/ext/dash.el.git/"))
     (add-to-list 'load-path (concat dotfiles-dir "/ext/pkg-info.el.git/"))
     (add-to-list 'load-path (concat dotfiles-dir "/ext/s.el.git/"))
   #+end_src
...
** Org
   ...
   #+BEGIN_SRC sh :tangle ~/.org-mobile-sync.sh
     #!/bin/bash
     
     # @hourly sh /home/nakkaya/.org-mobile-sync.sh >/dev/null 2>&1
     
     emacsclient --batch --load ~/.emacs --eval "(org-mobile-pull)" --eval "(org-mobile-push)"
   #+END_SRC
...
*** agenda
    ...
    #+begin_src emacs-lisp
      ...
      (setq org-mobile-directory "/scpc:nakkaya@kocatepe:/home/nakkaya/mobile-org")
