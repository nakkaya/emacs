  ...
  Works same as above but goes down in a directory tree.
   ...
   #+begin_src emacs-lisp
     ...
     (defun na-dired-open ()
       "Open file at point in an external application."
       (interactive)
       (let ((file-extension (file-name-extension (dired-get-filename))))
         (if (or (equal file-extension "pdf")
                 (equal file-extension "avi")
                 (equal file-extension "mp4")
                 (equal file-extension "wmv")
                 (equal file-extension "jpg")
                 (equal file-extension "JPG")
                 (equal file-extension "png")
                 (equal file-extension "m4v")
                 (equal file-extension "mpg"))
