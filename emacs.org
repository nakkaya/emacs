...
(use-package claudemacs
  ...
  :custom
  (claudemacs-program "/opt/claude-code/bin/claude")
  (claudemacs-notify-on-await nil)
  :bind
  ("C-c t" . claudemacs-transient-menu)
  :config
  ...
  (with-eval-after-load 'eat
    ...
    (customize-set-variable
     ...
     (append
      (list [29]) ;; C-] as character code 29
      eat-semi-char-non-bound-keys)))
  ...
  ;; Disable the bell handler
  (defun claudemacs-disable-setup-bell-handler ()
    "Disabled version of claudemacs-setup-bell-handler."
    (interactive))

  (advice-add 'claudemacs-setup-bell-handler
	      :override #'claudemacs-disable-setup-bell-handler))
#+end_src
