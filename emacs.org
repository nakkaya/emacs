...
(set-face-attribute 'mode-line nil :background "color-236" :foreground "#aab0ab")
(set-face-attribute 'mode-line-inactive nil :background "color-234" :foreground "#aab0ab")
