...
#+BEGIN_SRC emacs-lisp :results silent
  ...
  (setq na-theme-bg "unspecified-bg")

  (set-face-background 'org-block na-theme-bg)
  (set-face-background 'org-block-begin-line na-theme-bg)
  (set-face-background 'org-block-end-line na-theme-bg)
  ...
  (eval-after-load "magit"
    '(progn
       (remove-hook 'magit-section-highlight-hook 'magit-diff-highlight)
       (remove-hook 'magit-section-highlight-hook 'magit-section-highlight)
       (set-face-background 'magit-diff-context na-theme-bg)
       (set-face-background 'magit-diff-added-highlight na-theme-bg)
       (set-face-background 'magit-diff-context-highlight na-theme-bg)
       (set-face-background 'magit-diff-added na-theme-bg)
       (set-face-background 'magit-diff-removed na-theme-bg)
       (set-face-background 'magit-diff-hunk-heading na-theme-bg)
       (set-face-background 'magit-diff-removed-highlight na-theme-bg)))

  (set-face-background 'show-paren-match (face-background 'default))
  (set-face-attribute 'show-paren-match nil :foreground "red")
  (set-face-background 'show-paren-match na-theme-bg)
  ...
  (defun fix-theme-in-tty (&optional frame)
    ...
    (unless (display-graphic-p frame)
      ...
      (set-face-background 'org-hide "black" frame)
      (set-face-foreground 'org-hide "black" frame)))
