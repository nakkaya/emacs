...
(set-face-attribute 'mode-line nil :background "SteelBlue4" :foreground "gray5")
(set-face-attribute 'mode-line-inactive nil :background "SlateGray4" :foreground "gray15")
