...
(defun na-fix-background (&optional frame)
  (let ((frame (or frame (setq frame (selected-frame))))
    ...
    (eval-after-load "diff-mode"
      '(progn
	 (set-face-background 'ediff-current-diff-A "#262626" frame)
	 (set-face-background 'ediff-current-diff-Ancestor "#262626" frame)
	 (set-face-background 'ediff-current-diff-B "#262626" frame)
	 (set-face-background 'ediff-current-diff-C "#262626" frame)
	 (set-face-background 'ediff-even-diff-A "#262626" frame)
	 (set-face-background 'ediff-even-diff-Ancestor "#262626" frame)
	 (set-face-background 'ediff-even-diff-B "#262626" frame)
	 (set-face-background 'ediff-even-diff-C "#262626" frame)
	 (set-face-background 'ediff-fine-diff-A "#262626" frame)
	 (set-face-background 'ediff-fine-diff-Ancestor "#262626" frame)
	 (set-face-background 'ediff-fine-diff-B "#262626" frame)
	 (set-face-background 'ediff-fine-diff-C "#262626" frame)
	 (set-face-background 'ediff-odd-diff-A "#262626" frame)
	 (set-face-background 'ediff-odd-diff-Ancestor "#262626" frame)
	 (set-face-background 'ediff-odd-diff-B "#262626" frame)
	 (set-face-background 'ediff-odd-diff-C "#262626" frame)))
