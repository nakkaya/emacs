...
(defun na-fix-background ()
  (let ((bg "#1c1c1c"))
    (set-background-color bg)
    (set-face-background 'org-block bg)
    (set-face-background 'org-block-begin-line bg)
    (set-face-background 'org-block-end-line bg)
    (set-face-background 'show-paren-match bg)
    (eval-after-load "magit"
      '(progn
	 (remove-hook 'magit-section-highlight-hook 'magit-diff-highlight)
	 (remove-hook 'magit-section-highlight-hook 'magit-section-highlight)
	 (set-face-background 'magit-diff-context bg)
	 (set-face-background 'magit-diff-added-highlight bg)
	 (set-face-background 'magit-diff-context-highlight bg)
	 (set-face-background 'magit-diff-added bg)
	 (set-face-background 'magit-diff-removed bg)
	 (set-face-background 'magit-diff-hunk-heading bg)
	 (set-face-background 'magit-diff-removed-highlight bg)))))
