...
(global-set-key (kbd "C-c <right>") #'outline-indent-open-fold-rec)
(global-set-key (kbd "C-c <left>")  #'outline-indent-close-fold)
(global-set-key (kbd "C-c <up>")    #'outline-indent-close-folds)
(global-set-key (kbd "C-c <down>")  #'outline-indent-open-folds)
