...
(setq org-todo-keyword-faces
      '(;; sequence 1 — general
        ...
        ("WAITING"   . (:foreground "#ffcb6b" :weight bold :slant italic))       ; bright amber
        ("HOLD"      . (:foreground "#e06c75" :weight bold))                     ; bright red
        ("DONE"      . (:foreground "#b8e994" :weight bold :strike-through t))   ; bright green
        ("CANCELED"  . (:foreground "#9e9e9e" :weight bold :strike-through t))   ; light gray

        ;; sequence 2 — DL research pipeline
        ("DATASET"   . (:foreground "#c792ea" :weight bold))                     ; bright purple
        ("TRAINING"  . (:foreground "#89ddff" :weight bold))                     ; bright cyan
        ("WRITING"   . (:foreground "#ffd866" :weight bold))                     ; bright yellow
        ("PUBLISHED" . (:foreground "#b8e994" :weight bold :strike-through t))   ; bright green

        ;; sequence 3 — kanban
        ("BACKLOG"   . (:foreground "#ff79c6" :weight bold))                     ; bright pink
        ("READY"     . (:foreground "#82aaff" :weight bold))                     ; bright blue
        ("DOING"     . (:foreground "#ff9e64" :weight bold))))                   ; bright orange


(setq org-tag-faces
      '(("work"     . (:foreground "#82aaff" :weight bold))   ; blue
        ("personal" . (:foreground "#b8e994" :weight bold))   ; green
        ("research" . (:foreground "#c792ea" :weight bold)))) ; purple
#+end_src
