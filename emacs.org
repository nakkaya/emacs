...
(defun kernel-app (kernel &optional conn-name)
  (interactive (list (completing-read "Kernel: "
                                      (mapcar #'car (jupyter-available-kernelspecs t)))))
...
(set-face-attribute 'mode-line nil :background "color-238" :foreground "color-253")
(set-face-attribute 'mode-line-inactive nil :background "color-235" :foreground "color-243")
