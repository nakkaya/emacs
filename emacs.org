...
(defun na-xref-mode-hook ()
  (interactive)
  (toggle-truncate-lines)
  (hl-line-mode))

(add-hook 'xref--xref-buffer-mode-hook 'na-xref-mode-hook)
...
(eval-after-load 'clojure-mode
  '(define-key clojure-mode-map (kbd "<tab-bar> <mouse-movement>") #'ignore))
#+end_src
...
(when window-system
  (let ((height 130)
	(font-dejavu "DejaVu Sans Mono")
        (font-monaco "Monaco")
        (font-jetbrains "JetBrains Mono"))

    (cond ((member font-jetbrains (font-family-list))
	   (set-face-attribute 'default nil
			       :family font-jetbrains
			       :height height))
          ((member font-monaco (font-family-list))
           (set-face-attribute 'default nil
			       :family font-monaco
			       :height height))
          ((member font-dejavu (font-family-list))
           (set-face-attribute 'default nil
			       :family font-monaco
			       :height height)))))
