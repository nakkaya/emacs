...
(set-face-attribute 'mode-line nil :background "color-236" :foreground "color-253")
(set-face-attribute 'mode-line-inactive nil :background "color-234" :foreground "color-243")
