...
(dolist (hook '(c-mode-hook c++-mode-hook chatgpt-shell-mode-hook java-mode-hook))
...
(with-eval-after-load 'term
  ...
  (define-key term-raw-map (kbd "C-]")      #'na-helm-persp-buffers)
...
(with-eval-after-load 'vterm
  (define-key vterm-mode-map (kbd "C-]")      #'na-helm-persp-buffers)
