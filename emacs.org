...
(use-package aidermacs
  ;; :bind (("C-c t" . aidermacs-transient-menu))
  :custom
  (aidermacs-program "/opt/aider/bin/aider")
  (aidermacs-auto-commits nil)
  (aidermacs-default-model "claude-3-7-sonnet-latest")
  (aidermacs-weak-model "openai/gpt-4o@azure")
  ;; (aidermacs-use-architect-mode t)
  ;; (aidermacs-auto-accept-architect t)
  ;; (aidermacs-architect-model "claude-3-7-sonnet-latest")
  ;; (aidermacs-editor-model "openai/gpt-4o@azure")
  )
#+end_src
...
(setq claudemacs-program "/opt/claude-code/bin/claude"
      claudemacs-notify-on-await nil)

(global-set-key (kbd "C-c t") #'claudemacs-transient-menu)
...
(advice-add 'claudemacs-setup-bell-handler :override #'claudemacs-disable-setup-bell-handler)
#+end_src
...
(add-hook 'aidermacs-comint-mode-hook
          '(lambda ()
	     (define-key aidermacs-comint-mode-map (kbd "C-d")  #'na-bounce-sexp)))

(add-hook 'aidermacs-comint-mode-hook
	  '(lambda ()
	     (define-key aidermacs-comint-mode-map
	 		 (kbd "C-c C-o")
	 		 (lambda ()
			   (interactive)
			   (kill-region (point-min) (line-beginning-position 0))))))
