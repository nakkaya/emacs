...
(defun na-fix-background (&optional frame)
  (let ((frame (or frame (setq frame (selected-frame))))
    ...
    (eval-after-load "diff-mode"
      '(progn
	 ;; Define consistent diff colors (matching magit)
	 (let ((removed-fg "#ff6c6b")    ;; red for removed/old (A)
	       (added-fg "#98be65")      ;; green for added/new (B)
	       (ancestor-fg "#ECBE7B")   ;; yellow for ancestor
	       (diff-bg "#1f1f1f")
	       (fine-removed-bg "#251c1c")  ;; very subtle red bg for fine diff
	       (fine-added-bg "#1c251c"))   ;; very subtle green bg for fine diff

	   ;; Current diff faces (highlighted region being compared)
	   (set-face-attribute 'ediff-current-diff-A nil :background diff-bg :foreground removed-fg)
	   (set-face-attribute 'ediff-current-diff-B nil :background diff-bg :foreground added-fg)
	   (set-face-attribute 'ediff-current-diff-C nil :background diff-bg :foreground ancestor-fg)
	   (set-face-attribute 'ediff-current-diff-Ancestor nil :background diff-bg :foreground ancestor-fg)

	   ;; Even diff faces
	   (set-face-attribute 'ediff-even-diff-A nil :background diff-bg :foreground removed-fg)
	   (set-face-attribute 'ediff-even-diff-B nil :background diff-bg :foreground added-fg)
	   (set-face-attribute 'ediff-even-diff-C nil :background diff-bg :foreground ancestor-fg)
	   (set-face-attribute 'ediff-even-diff-Ancestor nil :background diff-bg :foreground ancestor-fg)

	   ;; Odd diff faces
	   (set-face-attribute 'ediff-odd-diff-A nil :background diff-bg :foreground removed-fg)
	   (set-face-attribute 'ediff-odd-diff-B nil :background diff-bg :foreground added-fg)
	   (set-face-attribute 'ediff-odd-diff-C nil :background diff-bg :foreground ancestor-fg)
	   (set-face-attribute 'ediff-odd-diff-Ancestor nil :background diff-bg :foreground ancestor-fg)
	   ...
	   (set-face-attribute 'ediff-fine-diff-C nil :background diff-bg :foreground ancestor-fg :weight 'bold)
	   (set-face-attribute 'ediff-fine-diff-Ancestor nil :background diff-bg :foreground ancestor-fg :weight 'bold))))
