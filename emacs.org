...
(defun my/forge-bury-topic (&optional kill-buffer)
  "Bury the Forge topic buffer, then go back to the window it came from.
KILL-BUFFER is passed on to `magit-mode-bury-buffer'."
  (interactive "P")
